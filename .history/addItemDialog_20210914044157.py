...
class Ui_Dialog(object):
    ...
    def clickAccept(self, Dialog):
        self.vals = list((self.product.text().capitalize(), 
    ...
    def setValues(self, valueList):
        ...
        self.priceSpinBox.setValue(valueList[2])
        self.company.setText(valueList[3])
        self.companyWebsite.setText(valueList[4])
        self.amount.setValue(valueList[5])
        self.size.setText(valueList[6])
        self.storageComboBox.setCurrentText(valueList[7])
        self.date.setDate(QtCore.QDate(
            int(valueList[8].split("-")[0]),
            int(valueList[8].split("-")[1]),
            int(valueList[8].split("-")[2])
        ))
