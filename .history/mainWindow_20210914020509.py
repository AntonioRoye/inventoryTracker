...
class Ui_MainWindow(object):
    ...
    def showAddItemDlg(self, windowTitle = None, productCode = None):
        if windowTitle == "Add Item":
            ...
            returnVal = dlg.exec()
            if returnVal == 1 and dlg.ui.vals[0] != "":
                try:
                    self.database.insertItem(dlg.ui.vals)
                except sqlite3.IntegrityError:
                    msg = QtWidgets.QMessageBox()
                    msg.setText("The item was not added to inventory")
                    msg.setInformativeText("The specified product code already exists in inventory.")
