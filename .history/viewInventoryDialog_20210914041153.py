...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        item = QtWidgets.QTableWidgetItem()
        self.productTable.setHorizontalHeaderItem(10, item)
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "Recipient"))
        item = self.productTable.horizontalHeaderItem(10)
    ...
    def addRows(self, rowList):
        for row in rowList:
            ...
            for i, colItem in enumerate(row):
                self.productTable.setItem(currentRowCount, i, QtWidgets.QTableWidgetItem(colItem))
